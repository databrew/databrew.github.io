...
#Section 2
  #Write in a comment in your code the main message of the video.
  #Find and write a link to a chart in an academic publication which you think is a good data visualization. 
    #Why do you think it’s good?
  #Find and write a link to a chart in an academic publication which you think is a bad data visualization. 
    #Why do you think it’s good?

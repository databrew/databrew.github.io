...
- If you have windows, go to http://tug.ctan.org/systems/win32/miktex/setup/basic-miktex-2.9.6236-x64.exe and download/install.
...
13. Run the same code as above, but not use `facet_wrap` to create separate visualizations for each year.
...
18. Having now examined the data visually, if you were the president of Sweden, would you have a speed limit or not? Why?
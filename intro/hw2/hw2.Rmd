...
Make sure to use comments (`#`) in your code indicating which could refers to which sections/numbers.
...
7. What was the hottest temperature in the data?

8. What was the coldest temperature in the data?
...
20. Make a cross table of `month` and `good_or_bad`. Call this cross-table `xt`. Make sure to put `good_or_bad` first.

21. Create an object called `pxt`. To do this, use `prop.table` to create a proportional table of `xt`. Add `1` to make the proportions by row.
...
25. Extra credit: Explain your weather criteria (ie, number 15) and why you think your conditions for a "good day" are better than other people's.

...
Given that our results don't show the trends observed everywhere in the world, further research is needed in the area and additional surveys done within manhiça R students population in order to be able to explain the factors that might drive their happiness. 
---
title: "Prevalence of Giardia lamblia in children under 5 years of age from Manhiça."
...
Diarrhea is curently one of the biggest public health problems in the world, especially in developing countries. It is the second most important cause of mortality in children under 5 and is among the major morbidity and mortality causes around the world [@Zebardast2016]. In Mozambique it is the 3rd and 4th cause of children mortality in Maputo and Manhiça, respectively, and in the latter diarrhea also accounts for up to 20% of the total children hospital admissions [@Dgedge2001, @Sacarlal2009, @Sacoor2013].

Previous studies in Manhiça have shown that diarrhea in children under 5 is mainly caused by Rotavirus, Cryptosporidium spp., ST Enterotoxigenic Escherichia coli and Shigella spp. [@Mandomando2007, @Nhampossa2015]. The Global Enteric Multicenter Study, a case control in which Manhiça was one of the sites, reported a high prevalence of infections by Giardia lamblia in both cases (children with diarrhea) and contrlols (assymptomatic children), but no comparison between this groups was made [@Nhampossa2015].
...
This study aimed to determine the prevalence of infection by G.lamblia in  children  under the age of 5 years (59 months) from Manhiça, a rural area of Southern Mozambique and to compare the situation between those with diarrhea - cases and those asymptomatic - controls.

# Methodology

The study was conducted at the Manhiça Health Research Centre (Centro de Investigação em Saúde de Manhiça - CISM) between 2007 and 2012. This study site has previously been described [@Nhacolo2006, @Sacoor2013]. 
...
ggplot(data = tabley,
  ...
  labs(x = "Age Group", y = "Number of Subjects",
       ...
       subtitle = "G. lamblia infection in children under 5 in Manhiça")+
  theme_economist()
```
...
Giardia lamblia had previosly been detected in Mozambique by several studies conducted in Maputo (the country's capital city) [@Fonseca2009, @Fonseca2014, @Chilaule2016], in Manhiça (a district in Maputo - Southern Mozambique) [@Nhampossa2015] and in Marrere (a locality in Nampula - Northern Mozambique) [@Guidetti2011].
